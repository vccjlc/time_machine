...
async def get_contest_messages():
    ...
    """
    with st.spinner("_Agents are talking. The conversation starts with a mysterious user calling upon God, who selects the topic and participants. A Host clarifies the topic, introduces the two participants, and guides them in presenting their arguments, while a Judge delivers the verdict, declaring the winner of the short debate._"):
        msgs = []
