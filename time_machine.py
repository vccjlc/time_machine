...
async def get_contest_messages():
    ...
    """
    with st.spinner("_Agents are talking. The conversation starts with a mysterious user calling upon God, who chooses the topic and participants. A Host clarifies the topic, and introduces two participants, guiding them to present the arguments, while a Judge delivers the verdict, declaring the winner of the short debate._"):
        msgs = []
