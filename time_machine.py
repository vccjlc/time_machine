...
async def get_contest_messages():
    ...
    """
    with st.spinner("_Agents are talking. The conversation begins with the initiator agent invoking God, who selects the topic and participants. A Host then clarifies the topic, introduces the two participants, and prompts them to present their arguments. Finally, a (biased) Host evaluates the discussion and declares the winner of the short debate. Rerun if the loading time is too long._"):
        msgs = []
